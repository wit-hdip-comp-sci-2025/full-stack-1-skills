---
name: persistence
description: Store abstraction (mem, JSON, Mongo), env config, and MongoDB seeding. Use when building persistence layers, adding Mongo/Mongoose, or seeding sample data.
metadata:
  tags: persistence, lowdb, dotenv, mongodb, mongoose, seeding, store-abstraction
---
